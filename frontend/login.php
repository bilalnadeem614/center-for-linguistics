...
<head>
    ...
    <title>Center for Linguistics - Login</title>
</head>
...
<body>
    ...
    <main class="w-full h-screen flex flex-col items-center justify-center px-4">
        <div class="max-w-sm w-full text-gray-600 space-y-6">
                ...
                <form onSubmit="event.preventDefault()" class="space-y-5">
                    ...
                    <div class="flex items-center justify-between text-sm">
                        ...
                        <a
                            ...
                            class="text-center text-indigo-600 hover:text-indigo-500">Forgot password?</a>
                    </div>
            ...
            <!-- Link to Sign-Up Page Moved to Bottom -->
            <div class="text-center">
                <p>
